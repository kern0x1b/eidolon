...
**1284 декларации Apple, которых у нас нет вовсе, и 309, которые есть, но с другой подписью** (вызов, который
...
- Модульные тесты движка: 331 проверка (раскладка, выравнивания, сетка, состояние, наблюдаемые объекты, окружение,
