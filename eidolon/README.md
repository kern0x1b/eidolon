...
**из 4740 деклараций Apple 3233 (68%) вызываются как у Apple, 1193 (25%) нет вовсе и 314 (7%) есть, но с другой подписью** (вызов, который
...
- Модульные тесты движка: 334 проверки (раскладка, выравнивания, сетка, состояние, наблюдаемые объекты, окружение,
